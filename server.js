...
var ScrapedData = require('./newsdb');

// Scrape data when app starts
var options = {
  url: 'https://www.soccor.com/fun/whats-new.html',
  headers: {
    'User-Agent': 'chrome (Windows; U; Windows NT 5.1; en-US; rv:1.8.1.13) Gecko/20080311 Firefox/2.0.0.13'
  }
};
